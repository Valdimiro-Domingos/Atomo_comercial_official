    ...
    <div class="container">
        ...
        <div class="row">
            @if (isset($dados['dados']->documento_numero))
                <div class="col-xs-4">
                    <p><strong>FACTURA {{ $dados['dados']->numero }}</strong></p>
            ...
            <div class="col-xs-6">
                ...
                <p><b>Formas de Pagamento:</b>
                 ...
                 @if ($dados['dados']->formapagamento_id == 4)
                    <p><b>Banco:</b>
                        {{ \App\Banco::find($dados['dados']->banco_id)->nome }}</p>
                @endif
            </div>
                    ...
                    <tbody>
                        @if ($dados['dados']->formapagamento_id == 4)
                            <tr>
                                ...
                                <td><b>{{ number_format($dados['dados']->total_caixa, 2, ',', '.') }}</b></td>
                            </tr>
                            <tr>
                                <td><b>Total Dinheiro</b></td>
                                <td><b>{{ number_format($dados['dados']->total_banco, 2, ',', '.') }}</b></td>
                            </tr>
                        @endif
