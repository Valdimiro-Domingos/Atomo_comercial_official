                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipo" placeholder="Escreva..." value="{{ $dados->tipo}}" >
                                
                            </div>

                            <div class="form-group">
                                <label for="nome">Código</label>
                                <input type="text" class="form-control" name="codigo" placeholder="Escreva..." value="{{ $dados->codigo}}" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="taxa" placeholder="Escreva..." value="{{ $dados->taxa}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="motivo" placeholder="Escreva..." value="{{ $dados->motivo}}" required>
