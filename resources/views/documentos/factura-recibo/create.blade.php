                                            ...
                                            <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control  select2"
                                                                    name="formapagamento_id" required onchange="changeFormaPagamento();">
                                                        ...
                                                        <div name="hide_show_formpag" class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label> Banco:</label>
                                                                        <select class="form-control  select2"
                                                                            name="banco_id" required>

                                                                            @foreach ($dados['bancos'] as $linha)
                                                                                <option value="{{ $linha->id }}">
                                                                                    {{ $linha->nome }}
                                                                                </option>
                                                                            @endforeach
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="total_banco"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="total_caixa"
                                                                            value="" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="hidden" name="item-artigo_id"
                                                            value="0">
                                                        <input type="hidden" class="hidden"
                                                            name="item-artigo_designacao" value="#">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select onchange="calcularItemArtigo();"
                                                            name="item-artigo_desconto" class="form-control  select2">
                                                            @for ($i = 0; $i <= 100; $i++)
                                                                <option value="{{ $i }}">
                                                                    {{ $i }}
                                                                </option>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden"
                                                            name="item-retencao_designacao"value="">
                                                        ...
                                                        <input type="hidden"
                                                            name="item-imposto_designacao"value="">
