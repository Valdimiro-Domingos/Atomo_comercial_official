                                            ...
                                            <div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Local Carga:</label>
                                                                <input type="text" name="local_carga"
                                                                    value="N/ Instalações" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Local Descarga:</label>
                                                                <input type="text" name="local_descarga"
                                                                    value="V/ Instalações" class="form-control">
                                                            </div>
                                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary btn-xs" onclick="finalizar('guia-transporte')">Finalizar</button>
