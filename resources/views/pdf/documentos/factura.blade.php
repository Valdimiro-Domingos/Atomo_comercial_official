    ...
    <div class="container px-0">
                ...
                <td colspan="8">
                        ...
                        <div class="row container">
                            <div class="col-xs-12 col-12 col-md-12 legenda  border-bottom px-0">
                                <span style="font-size: 9.5px;!important">{{ $dados['doc_via']}}</span>
                                <span><strong>FACTURA {{ $dados['dados']->numero }}</strong></span>
                                @if (isset($dados['dados']->documento_numero))
        ...
        @foreach ($dados['item'] as $item)
            @php
                ...
                $imposto = \App\Imposto::where('empresa_id', Auth::user()->empresa_id)->findOrFail($imposto_id);
        ...
        <div class="row px-0  d-flex justify-content-between align-items-center" style="margin-top: -2rem;">
            ...
            <div class="col-xs-4" style="margin-top: 4rem;">
                 <span style="font-size:8pt!important;">Os bens/serviços, foram colocados a disposição
                    do  adquirente na data:
