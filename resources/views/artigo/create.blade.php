...
@section('conteudo')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <strong class="text-success">OS CAMPOS MARCADOS COM <span class="text-danger">*</span> SÃO
                        OBRIGATÓRIOS</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="nome">Código <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="codigo" placeholder="Escreva..."
                                        value="{{ $dados['codigo'] }}" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="nome">Designação <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mask-money" name="preco" placeholder="Escreva..."
                                        value="" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mb-3 mb-sm-0 text-center">
                                <label class=newbtn_2>
                                    ...
                                    <br>
                                    <img id="blah_2" src='{{ asset('public/upload/null.png') }}'>
                            ...
                            <div class="col-sm-4 mb-3 mb-sm-0 text-center">
                                <label class=newbtn_3>
                                    ...
                                    <br>
                                    <img id="blah_3" src='{{ asset('public/upload/null.png') }}'>
                                           ...
                                           {{--      <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div
                                                            ...
                                                            <input type="checkbox" class="custom-control-input"
                                                                onclick="enable_is_stock()" id="is_stock" value=""
                                                                name="is_stock">
                                                ...
                                                <div class="col-md-6" id="enable_is_stock_1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control" name="stock_minimo"
                                                            placeholder="Escreva..." value="0">
                                                ...
                                                <div class="col-md-6" id="enable_is_stock_2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control"  value="0" name="stock_maximo"
                                                            placeholder="Escreva..." value="">
