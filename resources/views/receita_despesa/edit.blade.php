                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control  select2" name="tipo" required>
                                        <option value="1" {{ $dados->tipo == 1 ? 'selected' : '' }}>Receita</option>
                                        <option value="2" {{ $dados->tipo == 2 ? 'selected' : '' }}>Despesa</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mask-money" name="total"
                                        value="{{ $dados->total }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nome">Data</label>
                                    <input type="date" class="form-control" name="data" placeholder="Escreva..."
                                        value="{{ date('Y-m-d', strtotime($dados->data)) }}" required>
