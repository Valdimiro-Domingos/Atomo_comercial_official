            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{ route('home') }}" class="logo logo-light">
                            <span class="logo-sm">
                                  <img alt="" src="{{ asset('public/logo.svg') }}"  height="40">
                            </span>
                            <span class="logo-lg" style="margin:0rem 0 0; font-size:24px; color:grey; width:100%">
                                <img alt="" src="{{ asset('public/logo.png') }}" height="100">
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                        ...
                        function verificarExpiracaoApp($prazo_inicio = null, $prazo_termino = null)
                        {
                            ...
                            $prazoInicio = Carbon::parse($prazo_inicio);
                            $prazoTermino = Carbon::parse($prazo_termino);
                    
                            $diferenca = $prazoTermino->diff($prazoInicio);
                            $diasRestantes = $prazoTermino->diffInDays($hoje); // Calcular a diferença em dias
                        ...
                        $resultado = verificarExpiracaoApp(@Auth::user()->empresa->prazo_inicio, @Auth::user()->empresa->prazo_termino);
                    @endphp
                        ...
                        <div class="card_notification_body d-flex align-items-center h-100">
                            <p class="card-text">
                                @if($resultado['status'] == 'Expirado')
                                    <span class="span_red">Pagamento: Expirado</span>
                                @elseif($resultado['status'] == 'Efetuado')
                                    <span class="{{ $resultado['dias_restantes'] >= 5 ? 'span_green' : 'span_red' }}">Subscriço <br>{{ \Carbon\Carbon::parse(@Auth::user()->empresa->prazo_inicio)->format('d-m-Y') }}  | {{ \Carbon\Carbon::parse(@Auth::user()->empresa->prazo_termino)->subDay(1)->format('d-m-Y') }} </span>
                                @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-right d-none d-sm-block">
                                {{ __('Design & Develop by tomo Tecnologias') }}
                            </div>
                        </div>
                    </div>
                </div>
