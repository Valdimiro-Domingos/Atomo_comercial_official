...
class EmpresaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('empresa.index', compact('dados', 'isCreate', 'isHidden'));
    }
    ...
    public function register(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'nif' => 'required|string|min:10',
            'representante' => 'required',
            'telefone' => 'required',
        ], [
            'designacao.required' => 'nome da empresa obrigatorio',
            'email.email' => 'email invalido',
            'telefone.required' => 'email invalido',
            'email.required' => 'email obrigatorio',
            'nif.required' => 'NIF da empresa obrigatorio',
            'representante.required' => 'representante da empresa obrigatorio',
        ]);
        ...
        if ($validator->fails()) {
            ...
            session()->flash('alert_error', 'Dados invalido');
            return redirect()->back()->with('error', 'Dados invalido')->withErrors($errors->all());
        }
        ...
        if ($empresaCount > 0) {
            session()->flash('alert_error', 'Já existe uma empresa com estes dados');
            return redirect()->back()->with('error', 'Já existe uma empresa com estes dados');
        }
        ...
        $enderecoId = DB::table('enderecos')->insert([
            'pais' => 'Angola',
            'cidade' => 'Luanda',
            'endereco' => $faker->address,
        ]);

        // Inserir na tabela 'contactos'
        $contactoId = DB::table('contactos')->insert([
            'telefone' => '911222333',
            'telemovel' => '911222333',
            'email' => $faker->email,
        ]);

        // Recuperar o último registro inserido em 'contactos'
        $ultimoEndereco = DB::table('enderecos')->latest('id')->first();
        $ultimoContacto = DB::table('contactos')->latest('id')->first();
        ...
        $empresa->status = true;
        $empresa->id_endereco = $ultimoEndereco->id;
        $empresa->id_contacto = $ultimoContacto->id;
        $empresa->prazo_inicio = Carbon::now();
        $empresa->prazo_termino = Carbon::now()->copy()->addDays(8);
        
        $empresa->save();

        DB::table('enderecos')
            ->where('id', $ultimoEndereco->id)
            ->update(['empresa_id' => $empresa->id]);

        // Atualizar a tabela 'contactos' com o 'empresa_id'
        DB::table('contactos')
            ->where('id', $ultimoContacto->id)
            ->update(['empresa_id' => $empresa->id]);

        // Endereco::update(['empresa_id' => $empresa->id]);
        // Contacto::update(['empresa_id' => $empresa->id]);
        ...
        DB::table('departamentos')->insert([
            ['codigo' => '0001', 'empresa_id' => $empresa->id, 'designacao' => 'Administraço', 'descricao' => 'Administraão', 'status' => true],
        ...
        DB::table('impostos')->insert([
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M02', 'designacao' => 'M02 - Transmissão de bens e serviço no sujeita', 'taxa' => 0, 'motivo' => 'Regime Simplificado', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M11', 'designacao' => 'M11 - Isento nos termos da alínea b) do n1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea b) do nº1 do artigo 12. do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M12', 'designacao' => 'M12 - Isento nos termos da alnea c) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea c) do nº1 do artigo 12.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M14', 'designacao' => 'M14 - Isento nos termos da alínea e) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea e) do nº1 do artigo 12.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M16', 'designacao' => 'M16 - Isento nos termos da alínea g) do n1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea g) do nº1 do artigo 12.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M17', 'designacao' => 'M17 - Isento nos termos da alínea h) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea h) do n1 do artigo 12.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M18', 'designacao' => 'M18 - Isento nos termos da alínea i) do n1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea i) do nº1 do artigo 12.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M19', 'designacao' => 'M19 - Isento nos termos da alínea j) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea j) do nº1 do artigo 12. do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M20', 'designacao' => 'M20 - Isento nos termos da alnea k) do n1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea k) do n1 do artigo 12.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M21', 'designacao' => 'M21 - Isento nos termos da alínea l) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea l) do n1 do artigo 12.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M24', 'designacao' => 'M24 - Isento nos termos da alínea o) do nº1 do artigo 12.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea o) do n1 do artigo 12.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M80', 'designacao' => 'M80 - Isento nos termos da alínea a) do nº1 do artigo 14. do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea a) do n1 do artigo 14.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M81', 'designacao' => 'M81 - Isento nos termos da alínea b) do n1 do artigo 14.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea b) do nº1 do artigo 14.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M82', 'designacao' => 'M82 - Isento nos termos da alínea c) do n1 do artigo 14.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea c) do nº1 do artigo 14.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M85', 'designacao' => 'M85 - Isento nos termos da alínea a) do n2 do artigo 14. do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea a) do n2 do artigo 14.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M86', 'designacao' => 'M86 - Isento nos termos da alínea b) do nº2 do artigo 14.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea b) do n2 do artigo 14.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M32', 'designacao' => 'M32 - Isento nos termos da alínea c) do artigo 15.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea c) do artigo 15.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M33', 'designacao' => 'M33 - Isento nos termos da alínea d) do artigo 15.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alnea d) do artigo 15. do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M34', 'designacao' => 'M34 - Isento nos termos da alnea e) do artigo 15.º do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea e) do artigo 15.º do CIVA', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M35', 'designacao' => 'M35 - Isento nos termos da alínea f) do artigo 15. do CIVA', 'taxa' => 0, 'motivo' => 'Isento nos termos da alínea f) do artigo 15.º do CIVA', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M90', 'designacao' => 'M90 - Isento nos termos da alinea a) do nº1 do artigo 16.', 'taxa' => 0, 'motivo' => 'Isento nos termos da alinea a) do n1 do artigo 16.º', 'status' => true],
            ...
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M92', 'designacao' => 'M92 - Isento nos termos da alinea c) do nº1 do artigo 16.', 'taxa' => 0, 'motivo' => 'Isento nos termos da alinea c) do nº1 do artigo 16.', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M93', 'designacao' => 'M93 - Isento nos termos da alinea d) do nº1 do artigo 16.º', 'taxa' => 0, 'motivo' => 'Isento nos termos da alinea d) do n1 do artigo 16.º', 'status' => true],
            ['tipo' => 'ISENTO', 'empresa_id' => $empresa->id, 'codigo' => 'M93', 'designacao' => 'M94 - Isento nos termos da alinea e) do nº1 do artigo 16.', 'taxa' => 0, 'motivo' => 'Isento nos termos da alinea e) do nº1 do artigo 16.º', 'status' => true],
        ]);

        DB::table('retencaos')->insert([
            ['designacao' => 'Sem rentenção na fonte', 'empresa_id' => $empresa->id, 'taxa' => 0, 'status' => true],
            ['designacao' => 'Rentenão na fonte 6.5%', 'empresa_id' => $empresa->id, 'taxa' => 6.5, 'status' => true],
        ]);
        ...
        DB::table('modo_pagamentos')->insert([
            ...
            ['designacao' => 'Transferncia Bancária', 'empresa_id' => $empresa->id],
        ]);
        ...
        DB::table('motivo_anulacaos')->insert([
            ...
            ['codigo' => '0002', 'designacao' => 'Rectificaão', 'descricao' => '', 'empresa_id' => $empresa->id, 'status' => true],
        ...
        DB::table('fornecedors')->insert([
            ...
            DB::commit();
            session()->flash('alert_success', 'Empresa criada com sucesso');
            return redirect('login')->with('success', 'Sucesso');

        } catch (\Throwable $th) {
            // //throw $th;
            // return response()->json([$th->getMessage(), 'line' => $th->getLine()]);
            // DB::rollback();
               session()->flash('alert_error', 'Pedimos que atualize sua pagina e tente novamente');
            return redirect()->back()->with('error', 'Lamentamos')->withErrors(['Ocorreu um erro ao tentar processar os dados. Por favor, tente novamente.'])->withInput();
    ...
    public function default()
    {
        ...
        if (Auth::user()->empresa_id != 1 && Auth::user()->id != 1) {
        ...
        // Define uma varivel para indicar que é uma operação de criação (isCreate)
        $isCreate = true;
        $isHidden = true;
    ...
    {
        $isCreate = Auth::user()->empresa_id == 1 && Auth::user()->id != 1? true: false;
    ...
    public function payment(Request $request, $id){
        ...
        if(isset($request->prazo_inicio) && isset($request->prazo_termino)){
