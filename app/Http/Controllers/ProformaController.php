...
class ProformaController extends Controller
{
     ...
     */
     ...
     public function create()
     {
         ...
         $dados = array(
             'numero' => Serie::where('empresa_id', Auth::user()->empresa_id)->where('tipo', 'proforma')->get()[0]->designacao .' '.date('Y'). '/' . (count(Proforma::where('empresa_id', Auth::user()->empresa_id)->get()) + 1),
