...
class SaftController extends Controller
{
  ...
  public function header(Request $request)
  {
    ...
    <ProductID>ATOMO / ATOMO TECNOLOGIA SISTEMA - PRESTAÇAO DE SERVIOS, LDA</ProductID>
  ...
  public function masterFiles(Request $request)
  {
    ...
    $customer = '';
    foreach (Endereco::getClientes('clientes') as $key => $value) {
    ...
    $product = '';
    foreach (Artigo::where('empresa_id', Auth::user()->empresa_id)->get() as $key => $value) {
