...
<body>
    ...
    <div class="container px-0">
                ...
                <td colspan="8">
                        ...
                        <div class="row container">
                            <div class="col-xs-12 col-12 col-md-12 legenda  border-bottom px-0">
                                ...
                                <span style="font-size: 9.5px;!important">Motivo : <strong style="color: red;">{{ $dados['dados']->tipo_motivo_anulacao_designacao }}</strong></span>
                                <span><strong>NOTA DE CRDITO {{ $dados['dados']->numero }}</strong></span>
                                <span>Documento de origem: <strong>{{ $dados['dados']->documento_numero }}</strong></span>
                            </div>
                        </div>
                        <div class="container">
        ...
        <div class="row px-0  d-flex justify-content-between align-items-center" style="margin-top: -3rem;">
             <div class="col-xs-4">
