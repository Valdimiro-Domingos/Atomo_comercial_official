                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="home1" role="tabpanel">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="documento_numero"
                                                    value="{{ $dados['dados']->numero }}" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nome" style="color: red">Motivo</label>
                                        <select class="form-control  select2" name="motivo_anulacao_id" required>
                                            @foreach ($dados['motivo_anulacao'] as $linha)
                                                <option value="{{ $linha->id }}-{{ $linha->designacao }}">
                                                    {{ $linha->designacao }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nome">Tipo Motivo</label>
                                        <select class="form-control  select2" name="tipo_motivo_anulacao_id" required>
                                            @foreach ($dados['tipo_motivo_anulacao'] as $linha)
                                                <option value="{{ $linha->id }}-{{ $linha->designacao }}">
                                                    {{ $linha->designacao }}
                                                </option>
                                            @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" step="any"
                                                            ...
                                                            onchange="calcularItemRowArtigo();"
                                                    ...
                                                    <td>
                                                        <input type="hidden" style="text-align:center;" step="any"
                                                            class="form-control input-sm item-artigo_desconto"
                                                            value="{{ $item->desconto }}" readonly>
                                                        <select onchange="calcularItemRowArtigo();"
                                                            class="form-control  select2 item-artigo_row_desconto">
                                                            @for ($i = 0; $i <= 100; $i++)
                                                                <option value="{{ $i }}"
                                                                    {{ $item->desconto == $i ? 'selected' : '' }}>
                                                                    {{ $i }}
                                                                </option>
                                                            @endfor
                                                        </select>
                                                    ...
                                                    <td><button class="btn btn-danger btn-block"
                                                            onClick="removerItemArtigo(this);">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary btn-xs" onclick="finalizar('nota-credito')">Finalizar</button>
