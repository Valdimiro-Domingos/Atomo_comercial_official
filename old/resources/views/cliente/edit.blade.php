                    ...
                    <form enctype="multipart/form-data" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <label class=newbtn>
                                    <img id="blah" src='{{ asset("public/upload/{$dados[0]->imagem}") }}'
                                        width="100%">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="contribuinte" placeholder="Escreva..."
                                        value="{{ $dados[0]->contribuinte }}" {{$dados[0]->is_used == true ? 'readonly' : 'required' }}>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="pais" class="form-control select2">
                                                            <option value="{{ $dados[0]->pais }}">{{ $dados[0]->pais }}
                                                            </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="cidade"
                                                            placeholder="Escreva..." value="{{ $dados[0]->cidade }}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="endereco"
                                                            placeholder="Escreva..." value="{{ $dados[0]->endereco }}"
                                                            required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="telemovel"
                                                            placeholder="Escreva..." value="{{ $dados[0]->telemovel }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="contacto"
                                                            placeholder="Escreva..." value="{{ $dados[0]->contacto }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="telefone"
                                                            placeholder="Escreva..." value="{{ $dados[0]->telefone }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="fax"
                                                            placeholder="Escreva..." value="{{ $dados[0]->fax }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="email"
                                                            placeholder="Escreva..." value="{{ $dados[0]->email }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="facebook"
                                                            placeholder="Escreva..." value="{{ $dados[0]->facebook }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="whatsapp"
                                                            placeholder="Escreva..." value="{{ $dados[0]->whatsapp }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="skype"
                                                            placeholder="Escreva..." value="{{ $dados[0]->skype }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="twitter"
                                                            placeholder="Escreva..." value="{{ $dados[0]->twitter }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="linkedin"
                                                            placeholder="Escreva..." value="{{ $dados[0]->linkedin }}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="website"
                                                            placeholder="Escreva..." value="{{ $dados[0]->website }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="observacao" style="margin: 0px -17.6563px 0px 0px;  height: 143px;">
                                                        {{ $dados[0]->observacao }}</textarea>
                                </div>
                            </div>
                        </div>
