 ...
 */
 ...
 {
     $dados = array(
         'numero' => Serie::where('empresa_id', Auth::user()->empresa_id)->where('tipo', 'nota-debito')->get()[0]->designacao . '/' . (count(NotaDebito::where('empresa_id', Auth::user()->empresa_id)->get()) + 1),
